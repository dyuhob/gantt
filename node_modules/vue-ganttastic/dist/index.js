  ...
  methods: {
    ...
    getAxisDayObject: function getAxisDayObject(datetime, widthPercentage, endHour) {
      ...
      for (var i = 0; i <= endHour - startHour; i++) {
        var hour = {
          text: startHour+i == 0 ? datetimeMoment.format("MM월DD일") : datetimeMoment.format("HH:mm"),
...
var __vue_render__$3 = function __vue_render__() {
  ...
  return _c('div', {}, [_c('div', _vm._g({
    ...
    staticClass: "color-indicator",
    style: {
      background: this.bars[0].ganttBarConfig.backgroundColor
    }
  }), _vm._t("label", [_vm._v("\n      " + _vm._s(_vm.label) + "\n    ")])], 2), _vm._v(" "), _c('div', {
    ref: "barContainer",
...
var __vue_inject_styles__$3 = function __vue_inject_styles__(inject) {
  ...
  inject("data-v-419c73a4_0", {
    source: ".g-gantt-row[data-v-419c73a4]{display:flex;width:100%;height:40px;transition:background-color .2s}.g-gantt-row>.g-gantt-row-label>.color-indicator[data-v-419c73a4]{width:8px;height:8px;border-radius:100%;margin-right:4px}.g-gantt-row>.g-gantt-row-label[data-v-419c73a4]{display:flex;justify-content:center;align-items:center;width:20%;background:#fff;color:#424242;font-size:.8em;z-index:3;overflow:hidden;font-weight:700}.g-gantt-row>.g-gantt-row-bars-container[data-v-419c73a4]{position:relative;border-top:1px solid #eaeaea;width:70%;border-bottom:1px solid #eaeaea}",
    map: undefined,
    media: undefined
  });
};
